            ...
            <div className="w-auto rounded overflow-hidden shadow-lg ">
                <div className="px-6 pt-4 pb-2 flex flex-row">
                    ...
                    <div className='w-auto '>
                        <button type="button" className="py-2.5 px-5 lg:ml-28 mr-2 mb-2 flex text-sm font-medium text-white focus:outline-none bg-white rounded-lg border hover:border-white hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                            Create Notes
